players spawn into the game. 
  ...
  the player have to choose the loadout before starting a match. for example player keeps a primary gun, secondary gun, and utility they will have to use rest of the game. the player will be allowed to switch out the loadout ONCE but will reset their scraps and their utility count is 0