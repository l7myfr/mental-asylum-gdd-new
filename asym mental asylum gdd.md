...
survivors:
   security personnel:
      ...
      •  can place a camera around the map and then access it by pressing the same keybind. player can retrive the camera by getting near it and pressing the same keybind
